...
export default {
  ...
  messages: [
    ...
    `${p.highlight}Use ${p.rank}/donate ${p.highlight}to donate coppers to the server for prize pool`,
    ...
    `${p.highlight}Remember to upload your runs to the TMX`
  ],
